 ...
 */
  ...
  drupal_add_js(array('example_booking_calendar_granularity' => example_booking_get_calendar_granularity()), 'setting');
          ...
          <table>
            ...
            <tbody id="oho-non-regular-price-tbody">
              <%
                ...
                var timeRanges = <?php echo json_encode(example_booking_get_durations()); ?>;
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                <input type="text" class="text" name="oho-capacity" id="oho-extra-capacity" title="" size="8" value="<%= data.capacity %>" />
              </td>
            </tr>
          </tbody>
        </table>
      ...
      jQuery(function () {
        ...
        setTimeout (function () {
          ...
          jQuery('.start_time, .end_time').timeEntry({
            show24Hours: true,
            spinnerImage: false,
            timeSteps: [1, Drupal.settings.example_booking_calendar_granularity, 1]
          });
        }, 10);
